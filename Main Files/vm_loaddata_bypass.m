...
if dselect>=3
%     if dselect<7
%         disp('Estimation ignoring COVID sample can be done after July 2020 vintage')
%         return
%     end
    T           = find(datenum(YMX(2:end,1))==datenum('12/1/2019'));
%     Tdrop1      = find(datenum(YMX(2:end,1))==datenum('1/1/2020'));
%     Tdrop2      = find(datenum(YMX(2:end,1))==datenum('3/1/2020'));
    Tdrop1      = find(datenum(YMX(2:end,1))==datenum('3/1/2020'));
    Tdrop2      = find(datenum(YMX(2:end,1))==datenum('6/1/2020'));
